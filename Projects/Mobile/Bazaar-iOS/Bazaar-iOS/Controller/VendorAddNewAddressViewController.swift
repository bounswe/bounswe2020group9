//
//  VendorAddNewAddressViewController.swift
//  Bazaar-iOS
//
...
class VendorAddNewAddressViewController: UIViewController {
    ...
    @IBAction func openMapButtonPressed(_ sender: UIButton) {
        performSegue(withIdentifier: "VendorAddAddressToMap", sender: nil)
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "VendorAddAddressToMap" {
...
extension VendorAddNewAddressViewController:MapViewControllerDelegate{
