...
export default class AddProduct extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if (this.handleValidation()) {
      axios
        .post(serverUrl + `api/product/`, body, header)
        .then((res) => {
  ...
  render() {
    ...
    let subcategories = categoryStructure[this.state.category].map(
      (subcategory) => {
            ...
            <div className="account-update">
              ...
              >
                <div className="form-group row">
                  ...
                  <div className="col-6">
                    <input
                      ...
                      placeholder="e.g. 'Samsung Galaxy S, White'"
                ...
                <div className="form-group row">
                  ...
                  <div className="col-6">
                    <input
                      ...
                      name="detail"
                      className="form-control col"
                      placeholder="e.g. 'best phone, much cheap.'"
                      onChange={this.handleChange}
                    />
                  </div>
                </div>
                ...
                <div id="add-product-div">
                  <Button variant="primary" id="add-product" type="submit">
                    Add product
                  </Button>
                </div>
              </form>
