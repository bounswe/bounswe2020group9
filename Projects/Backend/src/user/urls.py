...
from product.views import ListListAPIView, ListDetailAPIView, CartAPIView, AlertListAPIView, AddProductAPIView
...
urlpatterns = [
    ...
    path('<int:id>/list/<int:list_id>/edit/', AddProductAPIView().as_view(), name="user-list-add"), # POST(private), DELETE(private) # TODO add/remove product to/from list
